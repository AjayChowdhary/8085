...
TEMPDIS:  	    MVI A,0CBH
				...
				MVI D,020H; SENDING DATA " "
				CALL DATA
				MVI D,054H; SENDING DATA "T"
				CALL DATA
				MVI D,065H; SENDING DATA "e"
				CALL DATA

				MVI D,06DH; SENDING DATA "m"
				CALL DATA
				MVI D,070H; SENDING DATA "p"
				CALL DATA
...
HDISPLAY:  	    MVI D,001H  ; SENDING COMMAND TO CLEAR DISPLAY
				CALL COMMAND
				MVI D,080H; COMMAND TO FORCE CURSOR FROM 1st LINE
				CALL COMMAND
				CALL DELAY
...
LOOP22:   ADI 01H              ;Count the number one by one 
...
DATA3: 
			...
			MOV A,C
			STA 0A002H; STORING MSB 
			MOV A,D
			STA 0A003H ; STORING LSB
			LDA 0A005H ; LOAD A WITH ADDRESS OF MSB OF HEART RATE
			CALL BCDTOASCII ; LSB - C, MSB - D
			MOV A,C
			STA 0A006H ; STORING MSB - THIS WILL ALWAYS BE 0 
			MOV A,D
			STA 0A007H ; STORING LSB
...
DELAYPSEC: PUSH B
				PUSH D  
				PUSH PSW
				MOV A,D;   SUBROUTINE FOR DELAY OF 1sec
LOOP63: MVI B,096H
LOOP64: MVI C,0FAH
LOOP65: MOV H,L
				MOV H,L
